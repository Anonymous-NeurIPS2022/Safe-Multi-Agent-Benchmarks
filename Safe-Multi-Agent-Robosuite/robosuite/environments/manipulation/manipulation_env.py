...
class ManipulationEnv(RobotEnv):
    ...
    def __init__(
        ...
        print("manipulation_env:num(robots):", num_robots)
        ...
        print("manipulation_env:robot_configs:", robot_configs)
        print("manipulation_env:robots:", robots)
    ...
    def _gripper_to_target(self, gripper, target, target_type="body", return_distance=False):
        ...
        print("target_pos---manipulation_env.py:", target_pos)
        print("gripper_pos---manipulation_env.py:", gripper_pos)
