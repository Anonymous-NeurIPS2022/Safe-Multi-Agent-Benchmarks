...
class TwoArmLift(TwoArmEnv):
    ...
    def reward(self, action=None):
        ...
        # print("self._gripper0_to_handle0:", self._gripper0_to_handle0)
        # print("self._gripper1_to_handle1:", self._gripper1_to_handle1)
        # print("self.sim.data.site_xpos[self.table_top_id][2]:", self.sim.data.site_xpos[self.table_top_id][2])
        # print("self.model.mujoco_arena.table_offset[2]:", self.model.mujoco_arena.table_offset[2])
        # print("self._eef0_xpos:", self._eef0_xpos)
        # print("self._eef1_xpos:", self._eef1_xpos)

        # self.pot_body_id = self.sim.model.body_name2id(self.pot.root_body)

        # print("self.robot_body_id0 :", np.array(self.sim.data.site_xpos[0]))
        # print("self.robot_body_id1 :", np.array(self.sim.data.site_xpos[1]))
        # print("self.robot_body_id2 :", np.array(self.sim.data.site_xpos[2]))
        # print("self.robot_body_id3 :", np.array(self.sim.data.site_xpos[3]))
        # print("self.robot_body_id4 :", np.array(self.sim.data.site_xpos[4]))
        # print("self.robot_body_id5 :", np.array(self.sim.data.site_xpos[5]))
        # print("self.robot_body_id6 :", np.array(self.sim.data.site_xpos[6]))
        # print("self.robot_body_id7 :", np.array(self.sim.data.site_xpos[7]))
        # print("self.robot_body_id8 :", np.array(self.sim.data.site_xpos[8]))
        # print("self.robot_body_id9 :", np.array(self.sim.data.site_xpos[9]))
        # print("self.robot_body_id10 :", np.array(self.sim.data.site_xpos[10]))
        # print("self.robot_body_id11 :", np.array(self.sim.data.site_xpos[11]))
        # print("self.robot_body_id12 :", np.array(self.sim.data.site_xpos[12]))
        # print("self.robot_body_id13 :", np.array(self.sim.data.site_xpos[13]))
        # print("self.robot_body_id14 :", np.array(self.sim.data.site_xpos[14]))
        # print("self.robot_body_id15 :", np.array(self.sim.data.site_xpos[15]))
        # print("self.robot_body_id16 :", np.array(self.sim.data.site_xpos[16]))
