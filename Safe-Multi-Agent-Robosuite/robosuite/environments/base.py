...
class MujocoEnv(metaclass=EnvMeta):
    ...
    def _initialize_sim(self, xml_string=None):
        ...
        # print("self.hole_obstacle_frame1_obstacle_pos--------------", self.hole_obstacle_frame1_obstacle_pos)
    ...
    def step(self, action):
        ...
        # print("action---environments/base.py:", action)
        ...
        # print("environments/base.py--first---reward:", reward)
    ...
    def _post_action(self, action):
        ...
        # print("environments/base.py---reward:", reward)
