...
class Controller(object, metaclass=abc.ABCMeta):
    ...
    def update(self, force=False):
        ...
        if self.new_update or force:
            ...
            # print("self.ee_pos_vel:", self.ee_pos_vel)
            # print("self.ee_ori_vel:", self.ee_ori_vel)
            ...
            # print("self.J_pos:", self.J_pos)
            # print("self.J_ori:", self.J_ori)
            # print("self.J_full:", self.J_full)
