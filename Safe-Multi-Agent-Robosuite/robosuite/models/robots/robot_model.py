...
class RobotModel(MujocoXMLModel, metaclass=RobotModelMeta):
    ...
    def set_base_xpos(self, pos):
        ...
        """
        print("pos--robot_model.py:", pos)  # table-xpos: (-0.56, 0, 0)  pos--robot_model.py: (-0.56, 0, 0)
        print("self.bottom_offset:", self.bottom_offset)  # self.bottom_offset: [ 0.     0.    -0.912]
        # print("self._elements[].set(, array_to_string(pos - self.bottom_offset)):", self._elements["root_body"].set("pos", array_to_string(pos - self.bottom_offset)))
    ...
    def set_base_ori(self, rot):
        ...
        print("rot-before---robot_model.py:", rot)
        rot = mat2quat(euler2mat(rot))[[3,0,1,2]]
        print("rot-after---robot_model.py:", rot)
    ...
    def add_mount(self, mount):
        ...
        print("offset---robot_model.py:", offset)
    ...
    def bottom_offset(self):
        ...
        """
        print("self.mount.bottom_offset---robot_model.py:", self.mount.bottom_offset) # self.mount.bottom_offset---robot_model.py: [ 0.     0.    -0.922]
        print("self.mount.top_offset---robot_model.py:", self.mount.top_offset) # self.mount.top_offset---robot_model.py: [ 0.    0.   -0.01]
        print("self._base_offset---robot_model.py:", self._base_offset) # self._base_offset---robot_model.py: [0. 0. 0.]
