...
class SingleArm(Manipulator):
    ...
    def _load_controller(self):
        ...
        print("self.robot_model.default_controller_config:", self.robot_model.default_controller_config)
        print("self.controller_config---single_arm.py:", self.controller_config)
    ...
    def reset(self, deterministic=False):
        ...
        # print("self.base_pos---single_arm.py:", self.base_pos)
        # print("self.base_ori---single_arm.py:", self.base_ori)
    ...
    def control(self, action, policy_step=False):
        ...
        # print("action---robots/single_arm.py:", action)
        gripper_action = None
        if self.has_gripper:
        ...
        if policy_step:
            ...
            # print("self.controller.ee_pos_vel---robots/single_arm.py:", self.controller.ee_pos_vel)
            # print("self.controller.ee_ori_vel---robots/single_arm.py:", self.controller.ee_ori_vel)
