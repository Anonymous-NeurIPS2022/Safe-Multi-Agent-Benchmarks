...
class Robot(object):
    ...
    def setup_references(self):
        ...
        # print("self.robot_model.joints---robots/robot.py:", self.robot_model.joints)
    ...
    def setup_observables(self):
        ...
        # print("self._ref_joint_vel_indexes:", self._ref_joint_vel_indexes)
    ...
    def check_q_limits(self):
        ...
        """
        tolerance = 0.1
        # print("q_limits[1]---robots/robot.py:", q_limits[1])
        # print("q---robots/robot.py:", q)
        for (qidx, (q, q_limits)) in enumerate(
            ...
            # print("q_limits[1]---robots/robot.py:", q_limits[1])
            # print("q---robots/robot.py:", q)
            # print("q_limits---robots/robot.py:", q_limits)
    ...
    def torque_limits(self):
        ...
        # print("torque_limits---robots/robot.py:", low)
    ...
    def _joint_positions(self):
        ...
        """
        # print("self.sim.data.qpos[self._ref_joint_pos_indexes]:", self.sim.data.qpos[self._ref_joint_pos_indexes])
        # print("====================================================")
        # print("self.sim.data.qvel[self._ref_joint_vel_indexes]:", self.sim.data.qvel[self._ref_joint_vel_indexes])
